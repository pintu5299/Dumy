...
{    // it is used for binding the fragment view
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        // requireActivity() function is used to retrieve the parent activity of Parent
   ...
   private  fun saveExpense(view: View)
   {
       ...
       if(expenseAmount.isNotEmpty () && expenseCategory.isNotEmpty() && expenseDescription.isNotEmpty()){
           ...
           Toast.makeText(addExpenseView.context, "Please full field all Details", Toast.LENGTH_SHORT).show()
       }
